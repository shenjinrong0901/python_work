...
void SaveIntToImage(int *im, char *what, char *filename,
                    int xsize, int ysize);
...
/*  Matrix allocation  */
void AllocateByteMatrix(unsigned char ***ptr, int rows, int cols, char *name);
void AllocateShortMatrix(short ***ptr, int rows, int cols, char *name);
void AllocateIntMatrix(int ***ptr, int rows, int cols, char *name);
void AllocateFloatMatrix(float ***ptr, int rows, int cols, char *name);
